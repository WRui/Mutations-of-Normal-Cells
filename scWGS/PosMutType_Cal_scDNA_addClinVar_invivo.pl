...
open (OUT, ">","$outdir/$sample/$sample.${depth}X_Exon_ClinVar_dbSNP_ann_invivo.txt") or die $!;
...
#	my @cells = @columns[9..200,393..$last_index]; ## CRC19
	my @cells = @columns[9..680,1833..$last_index]; ## CRC16
